...
do -- Petrol Engines
	...
	Engines.RegisterItem("7.0-V12", "V12", {
		...
		Torque		 = 726,
		Displacement = 7,
		FlywheelMass = { Realism = 18, Legacy = 0.45 },
		RPM = {
			Idle	= 800,
			Limit	= 6000,
		},
	...
	Engines.RegisterItem("13.0-V12", "V12", {
		...
		Torque		 = 932,
		Displacement = 13,
		FlywheelMass = { Realism = 100, Legacy = 2 },
		RPM = {
			Idle	= 700,
			Limit	= 4250,
		},
	...
	Engines.RegisterItem("23.0-V12", "V12", {
		...
		Torque		 = 2436,
		Displacement = 23,
		FlywheelMass = { Realism = 200, Legacy = 5 },
		RPM = {
			Idle	= 600,
			Limit	= 3250,
		},
...
do -- Diesel Engines
	Engines.RegisterItem("4.0-V12", "V12", {
		...
		Torque		 = 510,
		Displacement = 4,
		FlywheelMass = { Realism = 20, Legacy = 0.475 },
		RPM = {
			Idle	= 650,
			Limit	= 4000,
		},
	...
	Engines.RegisterItem("9.2-V12", "V12", {
		...
		Torque		 = 1202,
		Displacement = 9.2,
		FlywheelMass = { Realism = 50, Legacy = 2.5 },
		RPM = {
			Idle	= 675,
			Limit	= 3600,
		},
	...
	Engines.RegisterItem("21.0-V12", "V12", {
		...
		Torque		 = 4325,
		Displacement = 21,
		FlywheelMass = { Realism = 300, Legacy = 7 },
		RPM = {
			Idle	= 400,
			Limit	= 2000,
		},
