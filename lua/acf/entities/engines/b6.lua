...
Engines.Register("B6_Realism", {
	Name = "Flat 6 Engine",
})

do
	Engines.RegisterItem("2.8-B6", "B6_Realism", {
		...
		Torque		 = 170,
		Displacement = 2.8,
		FlywheelMass = { Realism = 7, Legacy = 0.08 },
		RPM = {
			Idle	= 750,
			Limit	= 7250,
		},
	...
	Engines.RegisterItem("5.0-B6", "B6_Realism", {
		...
		Torque		 = 412,
		Displacement = 5.0,
		FlywheelMass = { Realism = 7.5, Legacy = 0.11 },
		RPM = {
			Idle	= 900,
			Limit	= 6800,
		},
	...
	Engines.RegisterItem("8.3-B6", "B6_Realism", {
		...
		Torque		 = 606,
		Displacement = 8.3,
		FlywheelMass = { Realism = 28, Legacy = 0.65 },
		RPM = {
			Idle	= 500,
			Limit	= 4200,
		},
	...
	Engines.RegisterItem("15.8-B6", "B6_Realism", {
		...
		Torque		 = 1375,
		Displacement = 15.8,
		FlywheelMass = { Realism = 32, Legacy = 1 },
		RPM = {
			Idle	= 620,
			Limit	= 4900,
		},
	...
	Engines.RegisterItem("14.5-B6", "B6_Realism", {
		...
		Torque		 = 1995,
		Displacement = 14.5,
		FlywheelMass = { Realism = 125, Legacy = 3 },
		RPM = {
			Idle	= 620,
			Limit	= 2550,
		},
